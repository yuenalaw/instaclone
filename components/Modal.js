...
export default function Modal(){
    ...
    const addImageToPost = (e) => {
        ...
        if (e.target.files[0]) {
            reader.readAsDataURL(e.target.files[0]); //this fires reader.onload
        }
        //readerEvent -> we get file in an object, which we can actually store
        ...
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-28 text-center sm:block sm:p-0">
                    ...
                    {/**trick to centering the modal contents */}
                    ...
                    <Transition.Child
                        ...
                        leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scame-95"
                    >
                        ...
                        overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            <div>
                                {selectedFile ? (
                                    ...
                                    <div 
                                        /**executes a click on the hidden input field */
